var MAINAPP = (function (nsp, $, domU, strU) {
  ...
  */
  ...
  var loadJSON = function (path) {
      ...
      console.log(`local directory ${dir}`);
  ...
  var Question = function (obj) {
    ...
    switch (this.questionDiv) {
      case 'fill-in':
        ...
        break;
      case 'multi-choice':
        let distractors = htmlDiv.querySelectorAll('label');
        let distractorsRadio = htmlDiv.querySelectorAll('input');
        this.populateTheQuestion = function () {
          this.populateQuestion();
    ...
    Question.prototype.displayQuestion = function () {
      let checkTheAnswer = this.checkTheAnswer.bind(this);
      domU.removeClass([this.htmlDiv], 'hidden-question');
      domU.assignEvent(this.htmlDiv.querySelectorAll('.fill-in-submit.btn-primary'),
        'click', function () {
          checkTheAnswer();
        });
    };
